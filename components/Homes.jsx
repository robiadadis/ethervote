            ...
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
                    <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
                        E-Voting <br /> menggunakan Teknologi Blockchain
                    </h1>
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        ...
                        <div className={companyCommonStyles}>text</div>
                    ...
                    <>
                        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                            ...
                            <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
                                <h3 className="mt-2 text-white text-lg">Detail Admin & Pemilihan</h3>
                                <hr class="w-64 h-1 mx-auto my-4 bg-gray-100 border-0 rounded md:my-10 dark:bg-gray-700"></hr>
                                <p className="mt-1 text-white text-sm md:w-9/12">Nama Admin : {elDetails.adminName}</p>
                                <p className="mt-1 text-white text-sm md:w-9/12">Email Admin : {elDetails.adminEmail}</p>
                                <p className="mt-1 text-white text-sm md:w-9/12">Role : {elDetails.adminTitle}</p>
                                <p className="mt-1 text-white text-sm md:w-9/12">Judul Pemilihan : {elDetails.electionTitle}</p>
                                <p className="mt-1 text-white text-sm md:w-9/12">Organisasi : {elDetails.organizationTitle}</p>
                                <p className="mt-1 text-white text-sm md:w-9/12">Status Pemilihan : {elStarted ? (<>Sedang Berjalan</>) : (<>Belum Dimulai</>)}</p>
                            </div>
                        </div>
                    </>
                )
